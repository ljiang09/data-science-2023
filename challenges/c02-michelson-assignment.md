...
- In the first graph I generated, I was looking to see if there was a
  ...
  the temperature. If I unfocus my eyes, I can see a slight positive
  correlation. However, the actual data is essentially a huge cloud of
  scatter points, which means that the “positive correlation” is not a
  very trustworthy analysis. It is not possible to conclude that any
  relationship exists between measured velocity and temperature.
- In the second graph I generated, I was looking to see if the measured
  ...
  variable and `VelocityVacuum` is a continuous variable for our
  purposes. The mean velocity increases as the distinctness increases.
  Since a lack of distinctness suggests more inaccurate data, we can see
  that the more unclear the data, the more the measurement tends to
