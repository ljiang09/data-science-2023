...
-   Was your sample size $n$ large enough? Why do you say that?
    -   My sample size of 1,000,000 was large enough, because the true value of pi is within 0.01 of both confidence interval bounds. This is quite a tight confidence interval compared to the scale of pi (0.01 compared to 3.14), which means the sample size was large enough to generate a relatively accurate number.
