...
- If yes, what might account for those differences?
  - Maybe the day it was created was a while ago, and the dataset simply
    hasn’t been updated to account for that? Whereas Wikipedia can be
    edited any day to reflect updates in counting
