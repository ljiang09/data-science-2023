...
[Code Chunk Options](https://rmarkdown.rstudio.com/lesson-3.html) *Note*: Use
this reading to look up answers to the questions below. Rather than *memorizing*
this information, I recommend you download a
...
-   Within the script editor or a chunk
    ...
    -   `Cmd/Ctrl` + `Enter`: Run current selection

    -   `F1` (Note: on a Mac you need to press `fn` + `F1`): Show help for
        function at cursor
...
`Esc`, or click the stop button in the code chunk
