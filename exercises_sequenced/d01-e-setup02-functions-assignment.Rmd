...
## Put a question mark in front of the function name
?rnorm
```
...
```{r rnorm-source}
## Type the function name without the parentheses
rnorm
```
...
### **q4** Scroll to the bottom of the help for the `library()` function. How do you list all available packages?

```{r}
?library
```

    To list all available packages, run `library()`
