...
-   Is the bolded response **active** or **passive**? Why?
    -   It is active, because the presenter acknowledges the colleague's question with "Whoa good catch there" and actually answers their question
-   Is the bolded response **constructive** or **destructive**? Why?
    -   It is constructive, because the presenter compliments the colleague for pointing out their mistake with "good catch"
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   It makes me feel (if i was the colleague) that my question was worthy of attention and actually helpful. It makes me feel as if I can easily ask another question in the future without thinking twice.
...
-   Is the bolded response **active** or **passive**? Why?
    -   passive, because the response doesn't actually answer the colleague's question. "Moving on" essentially brushes off the colleague's question.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   constructive, because the presenter compliments the colleague for pointing out their mistake with "good catch"
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   Confused (did the presenter mean to ignore my question on purpose, or was it just a lapse in judgement?) and like I want to ask the question again.
...
-   Is the bolded response **active** or **passive**? Why?
    -   Passive, since the question doesn't actually refer to anything the presenter is talking about and therefore doesn't engage with it.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Uhhh probably destructive? Its more neutral in my opinion but it certainly doesn't seem positive (almost like a setup for an attack on the presenter's morals)
