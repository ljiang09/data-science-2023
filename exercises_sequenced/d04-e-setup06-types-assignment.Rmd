...
-   The variable `airport` was initialized to be a string, but it was attempted to be compared to a non-string value since ATL doesn't have quotations around it. You can't really compare two values of different types.
