...
-   This plot is super clear to read and therefore easy to understand,
    but it also has a very interesting conflict to examine since the
    trend in price across the cut quality between the two carat sizes
...
-   This one is kind of on the border between ABT and DHY, but I'm
    saying its DHY because its a bit more complicated than it needs to
    be, and it is hard to find just one point to discuss in the graph
...
-   This graph is not the best way to display this data and feels like
    there's just a lot of information being thrown at me but its all
    difficult to understand *because* it isn't depicted in the best way
